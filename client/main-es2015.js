...
module.exports = __webpack_require__(/*! /Users/cocodinos/Documents/Work/11-Aethon/00-Holdings/01-Projects/09-Matsukaze/01-Software/matsukaze/matsukaze-client/src/main.ts */"zUnb");
...
class AuthGuard {
    ...
    canActivate(next, state) {
        return this.auth.getUser$().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(user => !!user), // <-- map to boolean
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(loggedIn => {
            if (!loggedIn) {
...
AuthGuard.ɵfac = function AuthGuard_Factory(t) { return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"])); };
AuthGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: AuthGuard, factory: AuthGuard.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthGuard, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditorHomeComponent", function() { return EditorHomeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/services/api/api.service */ "oZWX");



class EditorHomeComponent {
...
EditorHomeComponent.ɵfac = function EditorHomeComponent_Factory(t) { return new (t || EditorHomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
EditorHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EditorHomeComponent, selectors: [["matsukaze-editor-home"]], decls: 2, vars: 0, consts: [[1, "top"], [1, "workspace"]], template: function EditorHomeComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditorHomeComponent, [{
    ...
    }], function () { return [{ type: src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] }]; }, null); })();
...
/* harmony import */ var _routing_auth_guard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../routing/auth.guard */ "DGLH");
/* harmony import */ var _components_editor_editor_home_editor_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/editor/editor-home/editor-home.component */ "P28B");
...
const routes = [
    { path: '', component: _components_editor_editor_home_editor_home_component__WEBPACK_IMPORTED_MODULE_3__["EditorHomeComponent"] },
    { path: 'editor', component: _components_editor_editor_home_editor_home_component__WEBPACK_IMPORTED_MODULE_3__["EditorHomeComponent"], canActivate: [_routing_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
    { path: '**', component: _components_app_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"] },
];
...
/* harmony import */ var _editor_story_editor_story_editor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../editor/story-editor/story-editor.component */ "Y9Ja");
/* harmony import */ var _auth_auth_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../auth/auth.component */ "qrmE");
...
/* harmony import */ var _api_spec_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../api.spec.json */ "1RlG");
var _api_spec_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../api.spec.json */ "1RlG", 1);
...
class ApiService {
    constructor(http) {
        ...
        this.user$ = null;
        if (this.test)
            this.root = _api_spec_json__WEBPACK_IMPORTED_MODULE_4__["root"].dev;
        else
            this.root = _api_spec_json__WEBPACK_IMPORTED_MODULE_4__["root"].test;
    }
    login$(email, password) {
        return this._request$(_api_spec_json__WEBPACK_IMPORTED_MODULE_4__["actions"].auth.login, { email: email, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(data => {
            var _a;
            if ((_a = data) === null || _a === void 0 ? void 0 : _a.user) {
                const user = data.user;
                this.user$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(user);
                return user;
            }
            else
                return null;
    ...
    request$(action, data, blob) {
        return this.isAuthenticated$().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(isAuthenticated => { console.log(isAuthenticated); if (isAuthenticated)
            return this._request$(action, data, blob);
        else
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(null); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["flatMap"])(req => { return req; }));
    }
    _request$(action, data, blob) {
        ...
        return req.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => {
            if (this.verbose) {
...
/* harmony import */ var _routing_app_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./routing/app-routing.module */ "W0X1");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "tk/3");
...
/* harmony import */ var ngx_drag_drop__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-drag-drop */ "+C6U");
...
/* harmony import */ var _components_app_app_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/app/app.component */ "WfQD");
/* harmony import */ var _components_auth_auth_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/auth/auth.component */ "qrmE");
/* harmony import */ var _components_editor_editor_home_editor_home_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/editor/editor-home/editor-home.component */ "P28B");
/* harmony import */ var _components_editor_story_editor_story_editor_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/editor/story-editor/story-editor.component */ "Y9Ja");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/api/api.service */ "oZWX");
/* harmony import */ var _services_editor_editor_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/editor/editor.service */ "ovZ/");
...
/* harmony import */ var _api_api_service_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api/api.service.js */ "YTy9");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StoryService, [{
    ...
    }], function () { return [{ type: _api_api_service_js__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }]; }, null); })();
...
class AuthComponent {
    ...
    submit() {
        this.authService.login$(this.email, this.password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(response => { if (response)
            this.retry = false;
        else
            this.retry = true; })).subscribe();
    }
}
AuthComponent.ɵfac = function AuthComponent_Factory(t) { return new (t || AuthComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"])); };
AuthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AuthComponent, selectors: [["matsukaze-auth"]], decls: 21, vars: 3, consts: [[1, "auth"], [1, "form"], [1, "form-group"], ["name", "email", "type", "email", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", "placeholder", "Your email", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "password", "name", "password", "id", "exampleInputPassword1", "placeholder", "Your password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"], [4, "ngIf"], ["href", "#"], ["src", "/client/assets/img/aethon-logo.jpg"]], template: function AuthComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AuthComponent_Template_input_ngModelChange_5_listener($event) { return ctx.email = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AuthComponent_Template_button_click_8_listener() { return ctx.submit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthComponent, [{
    ...
    }], function () { return [{ type: src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }]; }, null); })();
